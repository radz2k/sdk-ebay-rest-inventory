...
class OfferKeysWithId implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'offers' => '\Swagger\Client\Model\OfferKeyWithId[]'
    ];
