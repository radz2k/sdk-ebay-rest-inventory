...
class MigrateListingResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'inventory_items' => '\Swagger\Client\Model\InventoryItemListing[]',
        'listing_id' => 'string',
     ...
     * Sets errors
     *
     * @param \Swagger\Client\Model\Error[] $errors If one or more errors occur with the attempt to migrate the listing, this container will be returned with detailed information on each error.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\InventoryItemListing[]
     */
     ...
     * Sets warnings
     *
     * @param \Swagger\Client\Model\Error[] $warnings If one or more warnings occur with the attempt to migrate the listing, this container will be returned with detailed information on each warning. It is possible that a listing can be successfully migrated even if a warning occurs.
     *
     * @return $this
     */
