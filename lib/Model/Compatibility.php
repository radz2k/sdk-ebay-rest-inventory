...
class Compatibility implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'compatible_products' => '\Swagger\Client\Model\CompatibleProduct[]',
        'sku' => 'string'
    ];
     ...
     *
     * @return \Swagger\Client\Model\CompatibleProduct[]
     */
     ...
     *
     * @param \Swagger\Client\Model\CompatibleProduct[] $compatible_products This container consists of an array of motor vehicles (make, model, year, trim, engine) that are compatible with the motor vehicle part or accessory specified by the sku value.
     *
     * @return $this
     */
