...
class InventoryItemResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets errors
     *
     * @param \Swagger\Client\Model\Error[] $errors This container will be returned if there were one or more errors associated with the creation or update to the inventory item record.
     *
     * @return $this
     */
     ...
     * Sets warnings
     *
     * @param \Swagger\Client\Model\Error[] $warnings This container will be returned if there were one or more warnings associated with the creation or update to the inventory item record.
     *
     * @return $this
     */
